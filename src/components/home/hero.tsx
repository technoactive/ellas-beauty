...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-[76px]">
      <span
        aria-hidden
        className="pointer-events-none absolute -left-4 top-24 select-none font-script text-[11rem] leading-none text-gold/10 sm:text-[18rem] lg:text-[24rem]"
      >
        Ella
      </span>
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-end lg:gap-8">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-8 font-serif text-[clamp(2.75rem,6.2vw,5.75rem)] leading-[0.92] tracking-[-0.02em] text-ink">
              Lashes, brows
              <br />
              <span className="font-script text-[0.7em] leading-none text-gold-deep">
                &amp;
              </span>{" "}
              skin, <span className="italic font-normal">composed</span>
              <br />
              for you.
            </h1>
          ...
          <figure className="relative lg:col-span-5 lg:pl-6">
            ...
            <figcaption className="mt-8 flex items-start justify-between gap-6 border-t border-gold/30 pt-4 text-[0.66rem] tracking-[0.24em] text-muted uppercase">
      ...
      <div className="border-y border-gold/25">
