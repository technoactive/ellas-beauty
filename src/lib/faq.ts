export const faqs = [
  ...
  },
  {
    ...
    answer:
      "If you are new to tint, lash lift, brow lamination or eyelash extensions, a complimentary 15-minute patch test is recommended 24–48 hours before your appointment. You can book this on Fresha at no charge.",
  },
  {
    question: "How long do eyelash extensions last?",
    answer:
      "A full set typically looks its best for 2–3 weeks. Natural lashes shed in a cycle, so infills every two to three weeks keep the set even and protect lash health. Ella will map a style that suits the strength of your natural lashes rather than overloading them.",
  },
  {
    question: "What lash style should I choose?",
    answer:
      "Classic or hybrid is ideal if you want a polished mascara effect. Russian volume is fluffier and more glamorous. Kim K adds textured spikes, Kendall elongates into a cat eye, and mega volume is the fullest look. Ella advises on length and curl for your eye shape during the appointment.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Classic makeup, complex Arabic glam and bridal complex makeup are all available in salon or as a mobile appointment. For weddings, a trial is strongly recommended so the look, skin prep and timing are confirmed.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Many brow and makeup services can be adapted, but lash adhesives, tints and some skin treatments are not always appropriate. Please mention pregnancy or any medical condition when you book so Ella can advise honestly.",
  },
  {
